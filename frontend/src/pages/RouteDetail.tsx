    ...
    <div className="max-w-2xl mx-auto px-4 py-6 pb-24">
      ...
      {pendingBooking && (
        <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-2xl p-4 mb-4">
          ...
          >
            <svg viewBox="0 0 50 20" className="h-4 fill-white"><path d="M9.7 3c.7-1 1.8-1.6 3-1.5C12.9 2.8 12 4 11.3 5c-.7 1-1.8 1.6-3 1.5C8.1 5.2 9 4 9.7 3zm2.4 2.5c1.7 0 3.2 1 4 1 .9 0 2.2-1 3.7-1 1.2 0 3 .8 3.9 2.1-3.5 1.9-2.9 6.8.6 8.1-.5 1.5-1.2 3-2.2 4.2-.9 1.1-1.8 2.1-3.1 2.1-1.3 0-1.7-.8-3.2-.8-1.5 0-2 .8-3.1.8-1.3 0-2.3-1.1-3.2-2.2C8.2 18 7 15.2 7 12.5c0-4.3 2.8-6.6 5.1-6.6.2-.4.5.6 1 .6z"/></svg>
            Pay with Apple Pay
          </Link>
        </div>
      )}
